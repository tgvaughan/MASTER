...
public class InheritanceReactionStringParser {
    ...
    private List<master.inheritance.Node> reactants, products;
    ...
    Map<master.PopulationType,Integer> seenTypeIDs;
     ...
     */
    public InheritanceReactionStringParser(String string, List<master.PopulationType> popTypes) throws ParseException {
    ...
    public master.inheritance.Node[] getReactants() {
        return reactants.toArray(new master.inheritance.Node[0]);
    }
    
    public master.inheritance.Node[] getProducts() {
        return products.toArray(new master.inheritance.Node[0]);
    }
    ...
    private void ruleP(boolean processingReactants) throws ParseException {
        ...
        master.Population pop = new master.Population(popTypeMap.get(popName), loc);
        for (int i=0; i<factor; i++) {
            if (processingReactants)
                reactants.add(new master.inheritance.Node(pop));
            else
                products.add(new master.inheritance.Node(pop));
        }
